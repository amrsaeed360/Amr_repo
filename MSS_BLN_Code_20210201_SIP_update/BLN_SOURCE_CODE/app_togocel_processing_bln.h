...
char el_PRM_ANumber_CC[10];
char el_PRM_ANumber_TGT[10];
char el_PRM_BNumber_CC[10];
char el_PRM_BNumber_TGT[10];
...
char el_short_code[500];
char el_camel_level[5];
char I_Calling[30];
char el_CallREF[50];
char el_CDRType[10];
char el_date_time[30];
char EL_PRM_Calling_Prefix[10];
char EL_PRM_Calling_Prefix_TGT[10];
char EL_IN_TRUNK_ID[15];
char EL_PRM_Called_Prefix[10];
char EL_PRM_Called_Prefix_TGT[10];
char EL_OUT_TRUNK_ID[15];

char el_IN_Trunk_MOOV[100];
char el_IN_Trunk_INT[100];
char el_IN_Trunk_TGT[100];
char el_Out_Trunk_MOOV[100];
char el_Out_Trunk_INT[100];
char el_Out_Trunk_TGT[100];
/********************************************************************************
*
