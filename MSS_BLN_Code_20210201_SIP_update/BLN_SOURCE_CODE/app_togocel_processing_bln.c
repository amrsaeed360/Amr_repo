...
char* Input_Trunks_MOOV; 
char* Input_Trunks_INT;  
char* Input_Trunks_TGT;
char* Output_Trunks_MOOV;  
char* Output_Trunks_INT;
char* Output_Trunks_TGT;
void node_init(void)
{
   ...
   if(strcmp(Lookup_Table_Name, "") == 0)
    ...
    if( ls_initialize() == -1 )
    {
      ...
      Input_Trunks_MOOV = (char*)nb_get_parameter_string("Input_Trunks_MOOV");  
	  Input_Trunks_INT = (char*)nb_get_parameter_string("Input_Trunks_INT");  
	  Input_Trunks_TGT = (char*)nb_get_parameter_string("Input_Trunks_TGT");
	  
	  Output_Trunks_MOOV = (char*)nb_get_parameter_string("Output_Trunks_MOOV"); 
	  Output_Trunks_INT = (char*)nb_get_parameter_string("Output_Trunks_INT"); 
	  Output_Trunks_TGT = (char*)nb_get_parameter_string("Output_Trunks_TGT");
    //********************** 
		...
		if ((i_field_exists("I_CALLING_NUMBER")) && (i_field_exists("I_CALLED_NUMBER")))
		 {
			...
			else if ((((strcmp(el_PRM_ANumber_Series, "22870") == 0) || (strcmp(el_PRM_ANumber_Series, "22890") == 0) ||(strcmp(el_PRM_ANumber_Series, "22891") == 0) || (strcmp(el_PRM_ANumber_Series, "22892") == 0) || (strcmp(el_PRM_ANumber_Series, "22893") == 0)) && (strcmp(el_PRM_BNumber_CC, "228") != 0)) && (Interco_OutputTrunk_validate_International() == PASS))
			{
		...
		if ((i_field_exists("I_CALLING_NUMBER")) && (i_field_exists("I_CALLED_NUMBER")))
		 {
			...
			else if ((((strcmp(el_PRM_BNumber_Series, "22870") == 0) || (strcmp(el_PRM_BNumber_Series, "22890") == 0) ||(strcmp(el_PRM_BNumber_Series, "22891") == 0) || (strcmp(el_PRM_BNumber_Series, "22892") == 0) || (strcmp(el_PRM_BNumber_Series, "22893") == 0)) && (strcmp(el_PRM_ANumber_CC, "228") != 0)) && (Interco_InputTrunk_validate_International() == PASS))
			{
