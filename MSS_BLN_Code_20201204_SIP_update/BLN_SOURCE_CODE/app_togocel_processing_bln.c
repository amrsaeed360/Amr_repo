...
void node_init(void)
{
   ...
   if(strcmp(Lookup_Table_Name, "") == 0)
    ...
    if( ls_initialize() == -1 )
    {
      ...
      Input_Trunks = (char*)nb_get_parameter_string("Input_Trunks");
	  Output_Trunks = (char*)nb_get_parameter_string("Output_Trunks");
    //********************** 
...
void initialize_input_output_fields()
{
	...
	memset(el_IN_Trunk, '\0', sizeof(el_IN_Trunk));  
	memset(el_Out_Trunk, '\0', sizeof(el_Out_Trunk));
...
int Interco_InputTrunk_validate()
{
	
	char TRUNK [12] = {'\0'};
	int status = FAIL; 
	strcpy(el_IN_Trunk,Input_Trunks);
	DIAG(DIAG_MEDIUM, " Interco_InputTrunk_validate() : Trunks= %s",Input_Trunks );
	 ...
	 DIAG(DIAG_MEDIUM, " Interco_InputTrunk_validate() : TRUNK   = %s",TRUNK );
	  char * Numbers = strtok(el_IN_Trunk, "," );
	  while (Numbers != NULL)
        {
            DIAG(DIAG_MEDIUM, " Interco_InputTrunk_validate() : Trunks  = %s",Numbers );
...
int Interco_OutputTrunk_validate()
{
	
	char TRUNK [12] = {'\0'};
	int status = FAIL; 
	strcpy(el_Out_Trunk,Output_Trunks);
	DIAG(DIAG_MEDIUM, " Interco_OutputTrunk_validate() : Trunks= %s",Output_Trunks );
	 ...
	 DIAG(DIAG_MEDIUM, " Interco_OutputTrunk_validate() : TRUNK   = %s",TRUNK );
	  char * Numbers = strtok(el_Out_Trunk, "," );
	  while (Numbers != NULL)
        {
            DIAG(DIAG_MEDIUM, " Interco_OutputTrunk_validate() : Trunks  = %s",Numbers );
                if (strcmp (Numbers,TRUNK) == 0) {
                       return   PASS;
                }
                Numbers = strtok(NULL, ",");
...
{
	 int status = FAIL;
	 if((((strcmp(record_Type, "ptc") == 0) || (strcmp(record_Type, "STC") == 0))&& (Interco_OutputTrunk_validate() == PASS) )  || (((strcmp(record_Type, "poc") == 0) || (strcmp(record_Type, "SOC") == 0)) && (Interco_InputTrunk_validate() == PASS) ))
	{
		...
		if ((i_field_exists("I_CALLING_NUMBER")) && (i_field_exists("I_CALLED_NUMBER")))
		 {
			...
			else if( (strcmp(iGet("I_CALLING_NUMBER_TON"),"2") == 0 ) && (((strcmp(el_PRM_ANumber_Series, "22899") == 0) || (strcmp(el_PRM_ANumber_Series, "22898") == 0) ||(strcmp(el_PRM_ANumber_Series, "22897") == 0) ||(strcmp(el_PRM_ANumber_Series, "22894") == 0) || (strcmp(el_PRM_ANumber_Series, "22874") == 0)) || ((strcmp(el_PRM_BNumber_Series, "22899") == 0)  || (strcmp(el_PRM_BNumber_Series, "22898") == 0)  || (strcmp(el_PRM_BNumber_Series, "22897") == 0)  || (strcmp(el_PRM_BNumber_Series, "22894") == 0)  || (strcmp(el_PRM_BNumber_Series, "22874") == 0) )))
			{
	...
	if((i_field_exists("I_ORIG_CALLING_NUMBER") || i_field_exists("I_CALLING_NUMBER")))
	{
		...
		if(strcmp(record_Type, "moc") == 0 || strcmp(record_Type, "smmo") == 0 || strcmp(record_Type, "mtc") == 0 || strcmp(record_Type, "smmt") == 0 || (strcmp(record_Type, "poc") == 0) || (strcmp(record_Type, "ptc") == 0) || (strcmp(record_Type, "SOC") == 0) || (strcmp(record_Type, "STC") == 0) )	
		{
			...
			if((i_field_exists("I_CALLING_NUMBER_TON")))
			{
				...
				else if ((strcmp(i_get("I_CALLING_NUMBER_TON"),"4") == 0) && ((((strcmp(record_Type, "ptc") == 0) || (strcmp(record_Type, "STC") == 0)) && (Interco_OutputTrunk_validate() == PASS)) || (((strcmp(record_Type, "SOC") == 0) || (strcmp(record_Type, "poc") == 0)) && (Interco_InputTrunk_validate() ==PASS ))))
				{
					strcpy(el_a_number_updated,el_Local_Prefix);
				    strcat(el_a_number_updated,el_a_number);
				}
